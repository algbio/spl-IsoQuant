...
Note: Spl-IsoQuant will perform per-barcode quantification automatically.
...
splisoquant.py --large_output read_assignments corrected_bed read2transcripts allinfo ...

# Disable all large output files
splisoquant.py --large_output none ...
